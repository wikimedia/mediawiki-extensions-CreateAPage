...
<!-- s:<?php echo __FILE__ ?> -->
	<div class="createpage_input_file createpage_input_file_no_path">
		...
		<label id="createpage_image_label<?php echo $image_num ?>" class="button color1">
			<span id="createpage_image_text<?php echo $image_num ?>"><?php echo wfMessage( 'createpage-insert-image' )->escaped() ?></span>
			<span id="createpage_image_cancel<?php echo $image_num ?>" style="display: none"><?php echo wfMessage( 'cancel' )->escaped() ?></span>
		...
		<input type="hidden" name="wpUploadDescription<?php echo $image_num ?>" value="<?php echo wfMessage( 'createpage-uploaded-from' )->escaped() ?>" />
		...
		<noscript>
			<input type="submit" id="createpage_upload_submit<?php echo $image_num ?>" name="wpImageUpload" value="<?php echo wfMessage( 'createpage-upload' )->escaped() ?>" class="upload_submit" />
		</noscript>
	</div>
<!-- e:<?php echo __FILE__ ?> -->
